...
if __name__ == '__main__':
    ...
    # the annotation used below is the filtered version created by me -AG
    annotations_file = '../my_custom_dataset/annotations/coco_annotation.json'
    labels_target_folder = 'coco2voc_output'
    data_folder = '../my_custom_dataset/images'
