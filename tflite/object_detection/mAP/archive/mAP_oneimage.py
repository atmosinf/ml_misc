...
def get_bboxes_classes(model, img_root, img_name, conf_thresh=0.5, labelidxs=[0,21,23,24]):
    '''
...
def run():
    ...
    gtruths, preds = get_bboxes_classes(model, img_root, img_name, conf_threshold, labelidxs)
    mean_avg_prec = mean_average_precision(preds, gtruths, iou_threshold, box_format='corner', num_classes=50)
